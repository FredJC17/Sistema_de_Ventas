...
<body>
    <div class="modal-overlay active" id="buscarModal">
        <div class="modal-content">
            <span class="close-btn" onclick="window.location.href='store.php'">&times;</span>
            ...
            <form method="post" action="buscar.php?tipo=<?= htmlspecialchars($tipo) ?>">
                ...
                <div class="buttons-container">
                    <button type="button" class="btn-cancel" onclick="window.location.href='store.php'">Cancelar</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: store.php?busqueda=1");
    exit();
}
?>
</body>
