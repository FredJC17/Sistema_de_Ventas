...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->execute([$_POST['idProveedor']]);
        $_SESSION['popup'] = [
            'type' => 'success',
    ...
    <div class="modal-overlay active" id="eliminarModal">
        <div class="modal-content">
            ...
            <p style="margin: 30px 0 40px 0; font-size: 18px; color: #fff;">
                ¿Está seguro que desea eliminar al proveedor <b><?= htmlspecialchars($nombre) ?></b>?
            </p>
            <div class="buttons-container">
                <button type="button" class="btn-cancel" onclick="window.location.href='listado.php'">Cancelar</button>
                <form method="POST" style="display:inline;">
                    <input type="hidden" name="idProveedor" value="<?= htmlspecialchars($idProveedor) ?>">
